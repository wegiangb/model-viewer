...
export const LoadingMixin = (ModelViewerElement) => {
    return class extends ModelViewerElement {
        ...
        connectedCallback() {
            ...
            this[$posterElement].addEventListener('keydown', (event) => this[$onKeydown](event));
        }
        disconnectedCallback() {
            super.disconnectedCallback();
            this[$posterElement].removeEventListener('click', () => this[$onClick]());
            this[$posterElement].removeEventListener('keydown', (event) => this[$onKeydown](event));
        }
        dismissPoster() {
        ...
        update(changedProperties) {
            ...
            if (changedProperties.has('alt')) {
                posterElement.setAttribute('aria-label', `${this[$ariaLabel]}. ${this[$ariaLabelCallToAction]}`);
            }
