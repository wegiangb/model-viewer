...
export const EnvironmentMixin = (ModelViewerElement) => {
    return class extends ModelViewerElement {
        static get properties() {
            return Object.assign({}, super.properties, { backgroundImage: { type: String, attribute: 'background-image' }, backgroundColor: { type: String, attribute: 'background-color' }, experimentalPmrem: { type: Boolean, attribute: 'experimental-pmrem' } });
        }
        ...
        async [$setEnvironmentImage](url) {
            ...
            const textures = await textureUtils.generateEnvironmentTextures(url, { pmrem: this.experimentalPmrem });
        ...
        [$setEnvironmentColor](color) {
            ...
            const environmentMap = textureUtils.generateDefaultEnvironmentMap({ pmrem: this.experimentalPmrem });
            this[$applyEnvironmentMap](environmentMap);
        }
        /**
