...
export class SmoothControls extends EventDispatcher {
    ...
    update(_time, delta) {
        ...
        if (applyVelocity) {
            this[$velocity] = Math.min(this[$velocity] + this[$options].acceleration * frames, 1.0);
        }
        else if (this[$velocity] > 0) {
            this[$velocity] = Math.max(this[$velocity] - this[$options].acceleration * frames, 0.0);
        }
    ...
    get [(_a = $upQuaternion, _b = $upQuaternionInverse, _c = $spherical, _d = $targetSpherical, _e = $previousPosition, _f = $pointerIsDown, _g = $lastPointerPosition, _h = $velocity, $canInteract)]() {
